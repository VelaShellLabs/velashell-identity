...
namespace VelaShell.Identity.Endpoints;
...
public static class ConnectEndpoints
{
                                                      ...
                                                      IOpenIddictScopeManager scopes, CancellationToken cancel)
    {
        ...
        IdentityAccount? account = subject is null ? null : await accounts.FindByIdAsync(subject, cancel);
    ...
    private static async Task<IResult> ExchangeAsync(HttpContext context, AccountStore accounts, CancellationToken cancel)
    {
        ...
        string? stamp = granted.GetClaim(IdentityClaims.SecurityStamp);
    ...
    private static ClaimsIdentity CreateIdentity(IdentityAccount account)
    {
    ...
    private static IEnumerable<string> GetDestinations(Claim claim)
    {
        switch (claim.Type)
        {
            ...
            case IdentityClaims.SecurityStamp:
                yield break;
